            ...
            <el-tab-pane label="商品参数" name="second">
                <el-form  ref="dynamicValidateForm" label-width="100px" class="demo-dynamic">
                    <template v-for="(item,index) in parameterValue">
                        ...
                        <el-form-item v-for="(parameterValueEntry,index2) in item.parameterGroup" :key="index2">
                    ...
                    <el-col :offset="1" :span="19">
                        <template>
                            <el-checkbox-group
                                ...
                                :min="1"
                                :max="3">
                                <el-checkbox v-for="(attribute,index) in attributesStr" :label="attribute" :key="index">{{attribute}}</el-checkbox>
                            </el-checkbox-group>
                        </template>
                    </el-col>
                </el-row>
                <el-row v-for="(item,index) in checkedAttributes" :key="index" class="attribute_group">
                    <el-col :span="4" class="attribute_title">{{item.name}}</el-col>
                    <el-col :offset="1" :span="19">
                        <template v-for="(attributeValue,index2) in item.attributeValues">
                        ...
                        <el-table
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    <el-tag v-for="(item,index) in scope.row.attributeValues" :key="index" size="small"> {{item.value}} </el-tag>
                                </template>
                            </el-table-column>
                            <el-table-column
                                prop="price"
