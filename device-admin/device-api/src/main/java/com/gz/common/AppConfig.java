...
import com.gz.controller.MiniProgramController;
...
public class AppConfig extends JFinalConfig {
	...
	public static void main(String[] args) {
		 ...
		 */
		 JFinal.start("device-api/src/main/webapp", 80, "/");
	}
	...
	public void configRoute(Routes me) {
		...
		me.add("miniProgram", MiniProgramController.class);
	}
	...
	public void afterJFinalStart() {
		...
		TimedTask.getService().orderStatus();
	}
}
