        ...
        <el-tabs v-model="activeName">
            <el-tab-pane label="基本信息" name="first">
                <el-form  :model="lanmu" label-width="80px" ref="lanmu" >
                    ...
                    <el-form-item label="菜单类型" prop="lanmu_type" :rules="[
                                      { required: true, message: '请选择菜单类型', trigger: 'blur' }
                                      ]">
                        <el-select v-model="lanmu.lanmu_type"  placeholder="请选择菜单类型" @change="handleSelectlanmuType">
                            <el-option v-if="lanmu.up_levelId==0" value="0" label="菜单"></el-option>
                    ...
                    <el-form-item label="所属模块" prop="module_id" :rules="[
                                      { required: true, message: '请选择所属模块', trigger: 'blur' }
                                      ]">
                        <el-select v-model="lanmu.module_id"  placeholder="请选择模块" >
                            <el-option v-for="(item,index) in moduleCmb" :key="index" :value="item.id" :label="item.name"></el-option>
