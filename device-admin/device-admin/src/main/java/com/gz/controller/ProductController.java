...
import com.gz.common.model.Attribute;
import com.gz.common.model.AttributeValue;
import com.gz.common.model.Category;
import com.gz.common.model.Coupon;
import com.gz.common.model.Order;
import com.gz.common.model.Product;
import com.gz.common.model.ProductAttributeValue;
import com.gz.common.model.ProductPromotion;
import com.gz.common.model.Promotion;
...
public class ProductController extends Controller{
    public void getProductPage(){
        ...
        boolean isMarketable=getParaToBoolean("isMarketable",true);
        String condition=" isMarketable="+isMarketable;
        ...
        if(StringUtil.isEmpty(data)){
            ...
            for(int i=0;i<jsonArray.size();i++){
                ...
                if(productPromotion!=null){
                    ...
                    productPromotion.setStatus(jsonObject.getInteger("status"));
    ...
    public void getOrderList(){
        ...
        Page<Order> orderPage= OrderService.getService().getOrder( pageNum,  pageSize,  order_status,  null,  payment_status, shipping_status, false);
